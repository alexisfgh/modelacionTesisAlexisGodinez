...
if __name__=="__main__":
    ...
    #   Datos de la agencia de Tezoatlán de Yucuquimi de Ocampo
    x,y=leer('YucuquimideOcampo.csv')
    
    #   Estimacion de parámetros con condición inicial
    long, _ = sc.optimize.curve_fit(f, x, y, i, bounds=([0.0,0.0,1000],[1.0,1.0,15000]))
    ...
    savefig('EstimacionYucuquimi-n1-e1-k.eps')
